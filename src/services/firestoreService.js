...
const { saveOrder, getOrdersByUser, getOrderById, getAllOrders, findOrders, updateOrder, getOrdersByDriver, getOrdersByDriverFiltered, getOrdersPage, getOrdersPageByStatuses, countOrdersByStatusSince } = require('../repositories/orderRepository');
...
module.exports = {
  ...
  getCart, saveCart,
  // orders
  saveOrder, getOrdersByUser, getOrderById, getAllOrders, findOrders, updateOrder, getOrdersByDriver, getOrdersByDriverFiltered, getOrdersPage, getOrdersPageByStatuses, countOrdersByStatusSince,
  // addresses
